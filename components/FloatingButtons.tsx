  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <span className="absolute -top-2 -right-2 bg-white text-[#7a0c0c] text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full shadow-sm border border-gray-100">
          0
        </span>
      </motion.button>
    </AnimatePresence>
